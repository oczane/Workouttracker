...
exports.create = function(req, res) {
  console.log('before: ' + req.body.workout_description);
  console.log('after: ' + sanitizeHtml(req.body.workout_description));
  var workout_name = sanitizeHtml(req.body.workout_name); // Name of workout. 
  var description = sanitizeHtml(req.body.workout_description);  // Description of the workout
